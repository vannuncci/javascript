...
buttonElement.addEventListener('click', 
    function() { 
        ...
        // remover a classe result-success e result-fail e result-error
        removeClass();    
        // contar quantas tentativas o usuario fez
        tentativas++;
        // criar numero aleatorio de 1 a 100
        if (inputValue == '' || isNaN(inputValue) || (inputValue > 100 || inputValue < 1)) { 
            // se o numero digitado for vazio ou nao for um numero mostrar mensagem de numero invalido em vermelho.
            ...
            // se o numero digitado for igual ao numero sorteado mostrar mensagem de parabens em verde.
            ...
            // chamar funcao para salvar txt com a mensagem usando CreateTextFile
            saveTextAsFile();
        } else if (inputValue > numeroAleatorio) {
            // verificar se o numero digitado é maior que o numero sorteado 
            ...
            // verificar se o numero digitado é  menor que o numero sorteado
            resultadoMensagemElement.classList.add('result-fail');  
